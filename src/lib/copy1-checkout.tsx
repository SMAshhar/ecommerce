...
// import StripeCheckout from "../app/checkout/stripe";
...
// async function CartTile2({title, qty, price, images, size, id, handleDelete}: cartTile2) {
...
//                     className="flex flex-col justify-end items-start p-4"
//                 >
//                     <BiTrash />
//                 </button>
//             </div>
...
//                                 {/* {CartTile2(item.title, item.qty, item.price, item.images, item.size, item.id , handleDelete)} */}
//                                 <CartTile2 title={item.title} qty={item.qty} price={item.price} images={item.images} size={item.size} id={item.id} handleDelete={handleDelete} />
